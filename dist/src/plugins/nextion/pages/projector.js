                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 6:
                                ...
                                this.addListener("click_b3", function () {
                                    _this2.nanoDLP.command("/projector/blank");
                                ...
                                this.addListener("click_b7", function () {
                                    if (!_this2.status.Projecting) {
                                        _this2.nanoDLP.command("/projector/generate/white");
                                        _ = _this2.setText("b22", _this2.status.Projecting);
                                    }
                                });
