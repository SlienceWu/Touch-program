...
var Rom = function (_abstract) {
    _inherits(Rom, _abstract);

    function Rom(screenManager) {
        _classCallCheck(this, Rom);

        return _possibleConstructorReturn(this, (Rom.__proto__ || Object.getPrototypeOf(Rom)).call(this, screenManager));
    }
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.setScreen("rom");

                            case 2:
                                _context.next = 4;
                                return this.setText("t1", options.diskFree + "M");
